...
$string = $string . '{';
	...
	$string = $string . '"title":"Left Sensor",';
	//DESCRIPTION (displays on web... can include HTML)
	$string = $string . '"description":"Select a left sensor for your unit. ",';
	$string = $string . '"query_type":"category_ids",';
	//CATEGORY (CAT-NAME REQURIED)
	//EG: "query_ids":"Surveillance > Cameras > Mobotix > Mobotix Accessories > Sensors Modules > M16 Sensors",	
	$string = $string . '"query_ids":"Accessories > S16 Sensors",';
	...
	$string = $string . '"attribute_filters":["Product Colour","Sensor type"]';
...
$string = $string . '{';
	...
	$string = $string . '"title":"Right Sensor",';
	//DESCRIPTION (displays on web... can include HTML)
	$string = $string . '"description":"Select a right sensor for your unit. ",';
	$string = $string . '"query_type":"category_ids",';
	//CATEGORY (CAT-NAME REQURIED)
	//EG: "query_ids":"Surveillance > Cameras > Mobotix > Mobotix Accessories > Sensors Modules > M16 Sensors",	
	$string = $string . '"query_ids":"Accessories > S16 Sensors",';
